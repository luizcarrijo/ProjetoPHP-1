    ...
    <div align="center">
        ...
        <form action="">
            ...
            <div class="mb-3"  class="text-md-left">
                ...
                <input type="text" id="formGroupExampleInput" placeholder="Digite seu CPF/CNPJ">
                </div>
                <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Endereço:</label>
                <input type="text" id="formGroupExampleInput2" placeholder="Digite seu Endereço">
                </div>
                <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Número:</label>
                <input type="text" id="formGroupExampleInput" placeholder="Digite seu Número">
                </div>
                <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Bairro:</label>
                <input type="text" id="formGroupExampleInput2" placeholder="Digite seu Bairro">
                </div>
                <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Cidade:</label>
                <input type="text" id="formGroupExampleInput" placeholder="Digite sua Cidade">
                </div>
                <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">CEP:</label>
                <input type="text" id="formGroupExampleInput2" placeholder="Digite seu CEP">
                </div>
                <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Celular:</label>
                <input type="number" id="formGroupExampleInput" placeholder="(xx) xxxxx-xxxx">
                </div>
                <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">E-mail:</label>
                <input type="text" id="formGroupExampleInput2" placeholder="Digite seu E-mail">
                </div>
                <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Observações:</label>
                <input type="text" id="formGroupExampleInput" placeholder="Escreva sua observação">
            </div>
        </form>
        </table>
</div>
